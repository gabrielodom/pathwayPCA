...
5. Visualize Results (*vignette* in progress)
...
After you have confirmed that the `CreateOmics` function created the `Omics` object you wanted, you can analyze the object with adaptive, elastic-net, sparse (AES) PCA or supervised PCA. This section is a quick overview of the material covered in the [Test Pathway Significance](https://gabrielodom.github.io/pathwayPCA/articles/C4-Methods_Walkthrough.html) vignette. For details of these methods functions, please see their respective sections in Chapter 4.
...
```
```{r, echo = FALSE}
colon_aespcOut <- readRDS("suppl_data/colon_aespcOut.RDS")
```
...
```
```{r, echo = FALSE}
colon_superpcOut <- readRDS("suppl_data/colon_superpcOut.RDS")
```
...
# 5. Inspect Results
This section is a quick overview of the material covered in the [Visualizing the Results](https://gabrielodom.github.io/pathwayPCA/articles/C4-Methods_Walkthrough.html) vignette. The output of `AESPCA_pVals()` is list object with class `aespcOut`. The output of `SuperPCA_pVals()` is a list object with class `superpcOut`. Both of these objects have the following three elements:
...
- [Chapter 5: Visualizing the Results](https://gabrielodom.github.io/pathwayPCA/articles/C4-Methods_Walkthrough.html)
