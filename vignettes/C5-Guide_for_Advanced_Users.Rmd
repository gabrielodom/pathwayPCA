...
```
This shows us the pathway name (`Pathway`), gene symbols contained (`IDs`), any relevant details (`Description`), and the number of features in this pathway before and after trimming to match the given assay (`Size`).
