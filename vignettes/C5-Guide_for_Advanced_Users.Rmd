...
signifPaths005_idx <- which(
  wikipathways_PC$TERMS %in% signifPaths005_char
)
wikipathways_PC$description[signifPaths005_idx]
```
...
signifPaths010_idx <- which(
  wikipathways_PC$TERMS %in% signifPaths010_char
)
wikipathways_PC$description[signifPaths010_idx]
```
