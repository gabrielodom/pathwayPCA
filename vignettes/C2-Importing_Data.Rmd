...
2. `TERMS`: A character vector comprised of the proper name of each pathway in the pathways list.
...
Now we are prepared to create our first `Omics`-class object for analysis with either AES-PCA or Supervised PCA. Please read vignette 3 / 4: [Creating `Omics` Data Objects](https://gabrielodom.github.io/pathwayPCA/articles/C3-Create_Omics_Objects.html).
