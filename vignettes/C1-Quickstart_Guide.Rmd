...
- a list of all the pathway sets (`pathways`),
...
Specifically, the `description` field contains any notes or details on the pathway that is stored in the second entry of each row of the `.gmt` file.
