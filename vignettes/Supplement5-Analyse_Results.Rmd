...
Blue stands for negative PC1 score, Red stands for positive PC1 score
Inner loop stands for copyNumbers, outer loop stands for Proteomics
```{r}
##draw circle
library(circlize)
##set parameters
...
##for proteoOmics
circos.trackPlotRegion(ylim = c(0, 3), factors = factors, bg.col = proteoCol,
                       track.height = 0.3)
##for copy Number
circos.trackPlotRegion(ylim = c(0, 3), factors = factors, bg.col = copyCol,
                       track.height = 0.3)
##labels
suppressMessages(circos.trackText(rep(-3, npathway), rep(-3.8,npathway),
                 labels = "PID_IL1",
                 factors = factors, col = "#2d2d2d", font = 2,
                 adj = par("adj"), cex = 1.5,
