...
```{r echo=FALSE}
# saveRDS(ovarian_aespcOut, file = "vignettes/aespcaOut_20181009.RDS")
ovarian_aespcOut <- readRDS("aespcaOut_20181009.RDS")
```
...
- `n_tested`: number of genes in each pathway after being trimmed to match the assay data (as stored in the `ov_OmicsSurv@@trimPathwayCollection$$n_tested` object).
