...
# Website
Please see URL HERE for our hosted vignettes. Update the design of the website by editing the `_pkgdown.yaml` file. Update the content of the website pages by editing the vignettes and / or function documentation. When you update the website, run `pkgdown::clean_site()` then rebuild with `pkgdown::build_site()`.
