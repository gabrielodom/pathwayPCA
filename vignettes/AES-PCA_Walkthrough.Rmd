...
```{r create_OmicsSurv}
colon_OmicsSurv <- create_OmicsSurv(massSpec_df = cancers_df,
...
```{r create_OmicsReg}
colon_OmicsReg <- create_OmicsReg(massSpec_df = cancers_df,
                                  pathwaySet_ls = geneset_ls,
...
```{r create_OmicsCateg}
colon_OmicsCateg <- create_OmicsCateg(massSpec_df = cancers_df,
                                      pathwaySet_ls = geneset_ls,
