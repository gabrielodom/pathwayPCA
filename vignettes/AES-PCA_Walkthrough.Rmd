---
title: "Test Pathway Significance with pathwayPCA"
author: "Gabriel Odom"
date: "`r Sys.Date()`"
output:
...
vignette: >
  %\VignetteIndexEntry{AES-PCA with pathwayPCA}
...
### Calculate Pathway-Specific Model $p$-Values
For the Supervised PCA method, pathway $p$-values are calculated
...
For Supervised PCA, we see similar results to AES-PCA, but nearly half of the simulated pathways are significant. (Recall that the example data was curated so that seven of the 15 pathways would be significant.)
